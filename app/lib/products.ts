...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles Toronto | Gas Junction Cannabis",
    seoIntro: "Browse edible options at Gas Junction Cannabis. Compare product names, package details, posted notes, and current menu information before choosing.",
    seoDescription: "Edibles shop best when you compare the exact listing instead of guessing from an old example. Use the current menu at Gas Junction Cannabis for names, package details, posted prices, and staff help when needed.",
    faqs: [
      { q: "What edibles are listed at Gas Junction Cannabis?", a: "Use the current menu to compare edible names, package details, prices, and item notes." },
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Vapes Toronto | Gas Junction Cannabis",
    seoIntro: "Compare vape listings at Gas Junction Cannabis by product name, format, posted notes, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes Toronto | Gas Junction Cannabis",
    seoIntro: "Use the disposable vape category at Gas Junction Cannabis for current product names, formats, and menu notes.",
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Concentrates Toronto | Gas Junction Cannabis",
    seoIntro: "Compare concentrates at Gas Junction Cannabis by product type, name, posted notes, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoTitle: "Pre-Rolls Toronto | Gas Junction Cannabis",
    seoIntro: "Shop pre-rolls at Gas Junction Cannabis by comparing the current product name, format, package details, and posted notes.",
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories Toronto | Gas Junction Cannabis",
    seoIntro: "Browse accessories at Gas Junction Cannabis and compare the current menu notes before visiting.",
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | Gas Junction Cannabis",
    seoIntro: "Browse specialty items only where they are listed on the current Gas Junction Cannabis menu.",
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Toronto | Gas Junction Cannabis",
    seoIntro: "Native smokes at Gas Junction Cannabis in Toronto. The cigarette menu may show $25 carton-style listings and brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Classics Original, Canadian Classics Silver, and * Rolled Gold Lights.",
    seoDescription: "Use the cigarette category to compare current Native smoke listings at Gas Junction Cannabis. Specific brands, carton options, and prices can change, so check the current menu or ask staff before visiting.",
    faqs: [
      { q: "Does Gas Junction Cannabis list Native cigarettes?", a: "Check the cigarette category for current Native smoke listings and brand names." },
      { q: "What brands may be shown?", a: "The menu may show Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Classics Original, Canadian Classics Silver, and * Rolled Gold Lights. Confirm current options before visiting." },
