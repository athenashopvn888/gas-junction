...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse the full cannabis edibles menu at Gas Junction Cannabis on Toronto St, Toronto. We carry THC gummies, chocolates, drinks, and more from top Canadian brands.",
    seoDescription: "Looking for cannabis edibles in Toronto? Gas Junction Cannabis stocks a wide range of THC-infused gummies, chocolates, beverages, and baked goods. Our edibles range from micro-dose options for beginners to high-potency products for experienced consumers. All products are lab-tested and sourced from licensed Canadian producers. Visit us at 2813 Dundas St W — open daily 24 hours.",
    faqs: [
      ...
      { q: "Can I buy edibles at Gas Junction Cannabis?", a: "Yes! Visit us at 2813 Dundas St W, Toronto. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Gas Junction Cannabis, Toronto. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Gas Junction Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 2813 Dundas St W, Toronto.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Gas Junction Cannabis, Toronto. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Gas Junction Cannabis in Toronto. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 2813 Dundas St W — open daily 24 hours.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Gas Junction Cannabis, Toronto. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Gas Junction Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 2813 Dundas St W, Toronto.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoDescription: "Gas Junction Cannabis is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 2813 Dundas St W in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Gas Junction Cannabis, Toronto.",
    seoDescription: "Gas Junction Cannabis carries a curated selection of magic mushrooms and specialty products in Toronto. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 2813 Dundas St W for our full selection.",
    faqs: [
