...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    "seoTitle": "Gas Junction Cannabis Resources | Menu and Shopping Guides",
    "description": "Resource guides for shopping the Gas Junction Cannabis menu in Toronto, including flower, value, pre-rolls, and Native smokes where listed.",
    "eyebrow": "Resource Centre",
    "intro": "Welcome to the Gas Junction Cannabis resource centre. This is the no-stress corner for shoppers who want the menu to make sense before they visit. Pick the product lane, compare what matters, then use the current menu or staff for details that change.",
    "cards": [
      {
        "title": "Menu Guide",
    ...
    "sections": [
      ...
      {
        "heading": "Local Notes For The Junction",
        "body": "Gas Junction Cannabis serves shoppers around The Junction, Dundas St W, Keele, High Park North. If you searched for a weed dispensary in The Junction, this resource section keeps the visit simple: right store, right menu lane, right next step."
      }
    ]
  },
  {
    "slug": "menu-guide",
    "title": "How To Shop The Gas Junction Cannabis Menu",
    "seoTitle": "Gas Junction Cannabis Menu Guide | Toronto Weed Dispensary Tips",
    "description": "How to shop the Gas Junction Cannabis menu by category, with natural tips for flower, pre-rolls, edibles, THC vapes, concentrates, and value shopping.",
    "eyebrow": "Menu Guide",
  ...
  {
    "slug": "flower-guide",
    "title": "Gas Junction Cannabis Flower Guide",
    "seoTitle": "Gas Junction Cannabis Flower Guide | Exotic, Premium, Budget",
    "description": "Compare exotic flower, premium flower, budget weed, cheap weed, and affordable weed at Gas Junction Cannabis without guessing.",
  ...
  {
    "slug": "value-guide",
    "title": "Gas Junction Cannabis Value Guide",
    "seoTitle": "Gas Junction Cannabis Value Guide | Cheap Weed and Budget Weed",
    "description": "A practical value guide for shoppers comparing cheap weed, budget weed, affordable weed, and menu categories at Gas Junction Cannabis.",
    "eyebrow": "Value Guide",
  ...
  {
    "slug": "pre-roll-guide",
    "title": "Gas Junction Cannabis Pre-Roll Guide",
    "seoTitle": "Gas Junction Cannabis Pre-Roll Guide | Toronto Cannabis Menu Tips",
    "description": "How to compare pre-rolls at Gas Junction Cannabis without mixing them up with flower, edibles, THC vapes, and concentrates.",
  ...
  },
  {
    ...
    "title": "Gas Junction Cannabis Resource Centre Launch",
    "seoTitle": "Gas Junction Cannabis Resource Centre Launch",
    "description": "The Gas Junction Cannabis resource centre gives shoppers cleaner menu guides for flower, value, pre-rolls, and store visits.",
  ...
  {
    "slug": "native-smokes",
    "title": "Gas Junction Cannabis Native Smokes Resource",
    "seoTitle": "Gas Junction Cannabis Native Smokes | $25 Carton Notes",
    "description": "Gas Junction Cannabis Native smokes resource with cigarette brand names shown on the menu and $25 carton notes where listed.",
    "eyebrow": "Native Smokes",
    "intro": "Gas Junction Cannabis shoppers looking for Native smokes can use this page as a cleaner starting point. Brand names shown on the cigarette menu include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Classics Original, Canadian Classics Silver, * Rolled Gold Lights, Nexus Full, Nexus Lights, and Time Full. Some carton-style listings show around $25, but shoppers should check the current menu or staff before making the trip.",
    "cards": [
      {
  ...
  },
  {
    ...
    "title": "Gas Junction Cannabis Native Cigarettes Guide",
    "seoTitle": "Gas Junction Cannabis Native Cigarettes Guide | Brands and Carton Notes",
    "description": "A shopper-friendly Native cigarettes guide for Gas Junction Cannabis, including brand names shown on the menu and $25 carton notes where listed.",
    "eyebrow": "Native Cigarettes Guide",
    "intro": "If Native cigarettes are part of the stop, start with the cigarette category and compare the current listings. Gas Junction Cannabis menu brand names may include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Classics Original, Canadian Classics Silver, * Rolled Gold Lights, Nexus Full, Nexus Lights, and Time Full.",
    "cards": [
      {
        "title": "Cigarette Menu",
        "href": "/items/cigarettes",
    ...
    "sections": [
      {
        ...
        "body": "Look for the brand name first, then compare the posted price and any item notes. The menu may include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Classics Original, Canadian Classics Silver, * Rolled Gold Lights, Nexus Full, Nexus Lights, and Time Full.",
        "bullets": [
          "Canadian Lights",
          "Canadian Full",
          "Putters",
