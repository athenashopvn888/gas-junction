...
export const metadata: Metadata = {
  title: "FAQ | Gas Junction Cannabis",
  description: "Frequently asked questions about Gas Junction Cannabis in Toronto, including store-page checks, menu categories, value shopping, and Native smokes where listed.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Gas Junction Cannabis located?", a: "Gas Junction Cannabis is listed at 2813 Dundas St W, Toronto, ON M6P 1Y6. Use the store page for directions and contact options before visiting." },
      { q: "What are the listed hours?", a: "Open Daily: 09:00 AM - 02:00 AM. Check the current store page or contact staff before visiting if timing matters." },
  ...
  },
  {
    title: "Native Smokes",
    faqs: [
      { q: "Does Gas Junction Cannabis list Native cigarettes?", a: "The cigarette menu may show Native smoke brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Classics Original, Canadian Classics Silver, and * Rolled Gold Lights. Confirm current options through the menu or staff." },
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Straight answers for shopping Gas Junction Cannabis: store page first, menu category second, staff when the current detail matters.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call <a href="tel:+14375357027">(437) 535-7027</a> or use the store page before visiting.
            </p>
          </div>
        </div>
        <Footer />
