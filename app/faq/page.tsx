...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about Gas Junction Cannabis in Toronto. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Gas Junction Cannabis located?", a: "We are located at 2813 Dundas St W, Toronto, ON M6P 1Y6. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to Gas Junction Cannabis?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at gasjunctioncannabis.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Gas Junction Cannabis is walk-in only. Just show up anytime — we're open Open 24 Hours." },
