  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=GJC01`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          Gas Junction Cannabis is launching delivery across Toronto.
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            ...
            we are <strong>Open Daily: 09:00 AM - 02:00 AM</strong>. Call <strong>(437) 535-7027</strong>.
          </p>
        </div>
      </div>
      <Footer />
