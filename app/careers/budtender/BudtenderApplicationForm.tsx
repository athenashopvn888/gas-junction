...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Gas Junction" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="GJC01" />
      <input type="hidden" name="StoreName" value="Gas Junction Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Gas Junction?</span>
