...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Gas Junction Cannabis Visit Without Guessing",
    "seoTitle": "Gas Junction Cannabis Visit Guide | Weed Dispensary in the Junction",
    "seo_title": "Gas Junction Cannabis Visit Guide | Weed Dispensary in the Junction",
    "metaDescription": "Plan a the Junction visit to Gas Junction Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a the Junction visit to Gas Junction Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Gas Junction Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for Gas Junction Cannabis, written for shoppers who want the next step without the runaround.",
  ...
  },
  {
    ...
    "title": "How to Compare Gas Junction Cannabis Flower Without Guessing",
    "seoTitle": "Gas Junction Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Gas Junction Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Gas Junction Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Gas Junction Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Gas Junction Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Gas Junction Cannabis.",
    "author": "Theo Cross",
    "authorName": "Theo Cross",
    "authorHandle": "@TheoJunction",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "SHOPPER PERSONA POLISH",
    "primaryKeyword": "Gas Junction Cannabis flower guide",
    "wordCount": 549
  },
  {
    "slug": "gas-junction-cannabis-local-visit-guide-2026",
    "oldTitle": "Gas Junction Cannabis Local Visit Guide for Adults 19+",
    "title": "How to Shop the Gas Junction Cannabis Menu Like a Pro",
    "seoTitle": "Gas Junction Cannabis Menu Guide | the Junction Weed Store",
    "seo_title": "Gas Junction Cannabis Menu Guide | the Junction Weed Store",
    "metaDescription": "Shop the Gas Junction Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Gas Junction Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Gas Junction Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Gas Junction Cannabis menu without turning the visit into a guessing game.",
    "author": "Jules Junction",
    "authorName": "Jules Junction",
    "authorHandle": "@JulesAtTheJunction",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "SHOPPER PERSONA POLISH",
    "primaryKeyword": "Gas Junction Cannabis menu guide",
    "wordCount": 497
  }
];
