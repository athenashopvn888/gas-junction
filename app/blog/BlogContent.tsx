...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Gas Junction Cannabis is Toronto's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=GJC01`)
      .then((r) => r.json())
    ...
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          ...
          alt="Gas Junction Cannabis Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Gas Junction Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaSub}>
            200+ strains · Exotic to Budget · Open Daily: 09:00 AM - 02:00 AM
          </p>
