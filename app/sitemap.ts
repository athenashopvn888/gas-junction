...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/native-cigarettes-junction`, lastModified: now, changeFrequency: "weekly", priority: 0.75 },
    { url: `${BASE}/nicotine-vape-junction`, lastModified: now, changeFrequency: "weekly", priority: 0.75 },
