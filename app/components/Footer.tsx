        ...
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            ...
            <p className={styles.desc}>
              ...
              Open: Open Daily: 09:00 AM - 02:00 AM.
            </p>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.infoBlock}>
              ...
              <span><a href="tel:+14375357027" style={{color: "inherit"}}>(437) 535-7027</a></span>
            </div>
            <div className={styles.infoBlock}>
              <span className={styles.infoLabel}>Hours:</span>
              <span className={styles.highlight}>Open Daily: 09:00 AM - 02:00 AM</span>
            </div>
          </div>
          ...
          <div className={styles.col}>
            ...
            <nav className={styles.links}>
              ...
              <Link href="/blog/gas-junction-cannabis-local-visit-guide-2026">Local Visit Guide</Link>
