...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("GJC01_age_verified");
    if (verified !== "true") {
      setShow(true);
    }
  }, []);
  ...
  const handleVerify = () => {
    localStorage.setItem("GJC01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              <img
                ...
                alt="Gas Junction Cannabis"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              Gas Junction Cannabis requires all visitors to be of legal age.
