  ...
  return (
    <nav className={styles.navbar} id="main-nav">
      ...
      <div className={styles.topBar}>
        <Link href="/" className={styles.logo} aria-label="Gas Junction Cannabis" style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none" }}>
          <img src="/storeFavicon.webp" alt="Gas Junction Cannabis Logo" style={{ height: "30px", width: "30px", objectFit: "contain", borderRadius: "4px" }} />
