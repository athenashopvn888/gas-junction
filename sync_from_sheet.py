"""
Gas Junction Cannabis - Auto Sync from Google Sheets
==========================================
...
a filtered menu for Gas Junction Cannabis (ALC01).
...
def main():
    print("=" * 60)
    print(f"  Gas Junction Cannabis - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://gasjunctioncannabis.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
