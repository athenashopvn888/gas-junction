"""
Gas Junction Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the gas-junction folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Gas Junction Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://gasjunctioncannabis.com")
    else:
